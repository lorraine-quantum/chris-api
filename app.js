...
app.use(helmet());
app.use(cors({
  origin: ['http://localhost:5175', 'https://chris-admin.vercel.app', 'http://localhost:3000', 'https://binaryoptionsai.com']
}));
app.use(xss());
...
app.get('/', (req, res) => {
  res.json({ welcome: 'binary options ai production environment' })
})
